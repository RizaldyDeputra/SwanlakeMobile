...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    swanlakeAuthUserSubject.add(
      SwanlakeAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SwanlakeAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SwanlakeAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SwanlakeAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    swanlakeAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
