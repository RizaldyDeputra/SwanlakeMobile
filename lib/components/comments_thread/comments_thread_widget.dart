...
import 'comments_thread_model.dart';
export 'comments_thread_model.dart';

class CommentsThreadWidget extends StatefulWidget {
  const CommentsThreadWidget({super.key});

  @override
  State<CommentsThreadWidget> createState() => _CommentsThreadWidgetState();
}

class _CommentsThreadWidgetState extends State<CommentsThreadWidget>
    with TickerProviderStateMixin {
  late CommentsThreadModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommentsThreadModel());
