...
import 'desktopsn_laptops_page_model.dart';
export 'desktopsn_laptops_page_model.dart';

class DesktopsnLaptopsPageWidget extends StatefulWidget {
  const DesktopsnLaptopsPageWidget({super.key});

  static String routeName = 'DesktopsnLaptopsPage';
  static String routePath = '/desktopsnLaptopsPage';

  @override
  State<DesktopsnLaptopsPageWidget> createState() =>
      _DesktopsnLaptopsPageWidgetState();
}

class _DesktopsnLaptopsPageWidgetState extends State<DesktopsnLaptopsPageWidget>
    with TickerProviderStateMixin {
  late DesktopsnLaptopsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DesktopsnLaptopsPageModel());
